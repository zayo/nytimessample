...
class BaseContentFragment : Fragment(), Callback<ArticlesResponse> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        apiCall = when (ContentType.values()[arguments.getInt(PARAM_TYPE)]) {
            BaseContentFragment.ContentType.MAILED -> Api.mostMailed()
            BaseContentFragment.ContentType.SHARED -> Api.mostShared()
            BaseContentFragment.ContentType.VIEWED -> Api.mostViewed()
        }
    }
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        recycler.addItemDecoration(CardViewDecorator(activity.resources.getDimensionPixelSize(R.dimen.material_default)))
